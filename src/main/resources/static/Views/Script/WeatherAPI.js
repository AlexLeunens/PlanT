...
request.open('GET', 'https://api.openweathermap.org/data/2.5/onecall?lat=48.823071&lon=2.273390&appid=5582ef0be94efc6f5ec6e218b422f74f', true)
request.onload = function () {
	...
	var iconURL = getWeatherIcon("few clouds");
